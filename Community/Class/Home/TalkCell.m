...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        //头像  talkImag
        _talkImag = [[UIImageView alloc]initWithFrame:CGRectMake(10, 19, 12, 12)];
//        CALayer *picLayer1 = [_talkImag layer];
//        [picLayer1 setMasksToBounds:YES];
//        [picLayer1 setCornerRadius:4.0];
        _talkImag.image = [UIImage imageNamed:@"讨论1.png"];
        _talkImag.hidden = YES;
        [self.contentView addSubview:_talkImag];
...
//        _deleteBtn.backgroundColor = [UIColor redColor];
        ...
        //分割线                                                //最后把 table 系统分割线去掉就实现了  30 效果
        _imageLine = [[UIImageView alloc]initWithFrame:CGRectMake(30, _content.frame.size.height+43.5, 320, 0.5)];

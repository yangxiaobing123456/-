...
//        [self addSubview:nameFieldBg];
        ...
        _nameField = [[UITextField alloc] initWithFrame:CGRectMake(150, 0.0f, 140, 20)];
        _nameField.backgroundColor = [UIColor clearColor];
        _nameField.font = [UIFont systemFontOfSize:17.0f];
        _nameField.delegate = self;
        _nameField.textAlignment=NSTextAlignmentRight;
        _nameField.textColor = [UIColor colorWithHexValue:0xFF767477];
        _nameField.keyboardType = UIKeyboardTypeDefault;
        _nameField.clearButtonMode = UITextFieldViewModeWhileEditing;
        _nameField.returnKeyType = UIReturnKeyDefault;
        _nameField.contentVerticalAlignment = UIControlContentHorizontalAlignmentCenter;
...
{
    _nameField.text = _editProfile.name;

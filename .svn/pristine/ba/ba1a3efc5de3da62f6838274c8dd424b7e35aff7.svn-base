...
//为了适配IOS6 替换方法[[self parentViewController] dismissModalViewControllerAnimated:YES];
...
//适配IOS6替换	[[self presentingController] presentModalViewController:self animated:YES];

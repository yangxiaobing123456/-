//
//  personIntergelViewController.m
//  Community
//
...
@interface personIntergelViewController ()

@end

@implementation personIntergelViewController
...
- (void)viewDidLoad {
    ...
    titleLabel.text =[NSString stringWithFormat:@"现有益钱包:%@元",[d objectForKey:@"personWallet"]];
    ...
    [titleImage setImage:[UIImage imageNamed:@"钱包logo"]];
...
-(void)request{
    ...
    if ([NSJSONSerialization isValidJSONObject:user])
    {
        ...
        NSURL *url = [NSURL URLWithString:getWalletRecords];
